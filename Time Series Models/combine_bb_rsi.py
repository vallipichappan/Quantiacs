...
##    -----Bollinger Bands------
    def bollingerBands(a, n=20):
        sma = np.nansum(a[-n:]) / n #take all the nan as 0 then sum it up / number of days
...
def RSI(CLOSE,period):
    closeMom = CLOSE[1:]- CLOSE[:-1]   #array of value at the next step - value at the previous step 
